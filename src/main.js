...
<p><strong>Almacenamiento:</strong> La información se almacena de forma segura en una base de datos institucional administrada por el equipo designado. Se mantendrá durante el tiempo necesario para cumplir con las finalidades descritas y conforme a los plazos de conservación establecidos por la normativa aplicable.</p>
...
<p><strong>Actualización:</strong> Los datos presentados en los dashboards se actualizan en tiempo real conforme se reciben y procesan nuevas solicitudes, reflejando al instante el alcance de los programas preventivos.</p>
